      ...
      <form onSubmit={handleSubmit} className="space-y-8"> {/* Increased space-y */}
        ...
        <div className="form-control">
          ...
          <div className="relative">
            ...
            <input
              type="text"
              className="input input-bordered w-full pl-12 h-12 text-lg"  // Adjusted padding and height
        ...
        <div className="form-control">
          ...
          <div className="relative">
            ...
            <input
              type="email"
              className="input input-bordered w-full pl-12 h-12 text-lg"
  ...
  <div className="relative">
    ...
    >
      {showConfirmPassword ? <EyeOff className="size-5 text-base-content/40" /> : <Eye className="size-5 text-base-content/40" />}
        ...
        {/* Submit Button */}
        <button type="submit" className="btn btn-primary w-full h-12 text-lg" disabled={isSigningUp}>
          {isSigningUp ? (
            <>
